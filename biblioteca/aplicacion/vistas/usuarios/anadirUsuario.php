...
echo CHTML::dibujaEtiqueta("div", ["class" => "verObra", "style" => "margin-left: 20%;"], null, false).PHP_EOL;
    ...
    echo CHTML::dibujaEtiqueta("h2", [], "Añadir usuario: " , true).PHP_EOL;
    ...
    echo CHTML::iniciarForm("", "post", []).PHP_EOL;
        ...
        echo CHTML::modeloError($usuario ,"nick", ["class" => "error"]).PHP_EOL;

        //nombre
        echo CHTML::modeloLabel($aclUser, "nombre", []) . PHP_EOL;
        echo CHTML::modeloText($aclUser, "nombre",  ["required" => true]) . PHP_EOL;
        ...
        echo CHTML::modeloNumber($usuario, "cp", ["class" => "campoNumero", "required" => true]).PHP_EOL;
        ...
        echo CHTML::modeloEmail($usuario, "email",["required" => true]).PHP_EOL; 
        echo CHTML::modeloError($usuario ,"email", ["class" => "error"]).PHP_EOL;


        //fecha de nacimiento
        echo CHTML::modeloLabel($usuario, "fecha_nacimiento", []).PHP_EOL;
        echo CHTML::modeloDate($usuario, "fecha_nacimiento", ["required" => true]).PHP_EOL;
        ...
        echo CHTML::modeloListaDropDown($aclUser, "cod_acl_role", $arrayRole, ["required" => true]) . PHP_EOL;
        ...
        echo CHTML::campoPassword("contraAcl", $datosForm["contraAcl"], ["maxlength" => 10, "required" => true]) . PHP_EOL;
        if (isset($errores)) {
        ...
        echo CHTML::campoPassword("contraAcl1", $datosForm["contraAcl1"], ["maxlength" => 10, "required" => true]) . PHP_EOL;
        if (isset($errores)) {
        ...
        echo CHTML::modeloListaRadioButton($usuario, "borrado", [0=>"NO", 1=> "SI"], " ", ["required" => true]).PHP_EOL;
        echo CHTML::modeloError($usuario, "borrado", ["class" => "error"]).PHP_EOL;
        echo CHTML::modeloError($usuario ,"borrado", ["class" => "error"]).PHP_EOL;

        echo "<br>".PHP_EOL;

        echo CHTML::campoBotonSubmit("Añadir datos",  ["class" => "boton"]).PHP_EOL;
